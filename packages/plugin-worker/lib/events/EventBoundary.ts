...
import type { Cursor, EventMode, FederatedEventHandler } from './FederatedEventTarget';
...
export class EventBoundary {
  ...
  protected createPointerEvent(from: FederatedPointerEvent, type?: string, target?: Container): FederatedPointerEvent {
    ...
    event.target = target ?? (this.hitTest(event.global.x, event.global.y) as Container) ?? this._hitElements[0];
