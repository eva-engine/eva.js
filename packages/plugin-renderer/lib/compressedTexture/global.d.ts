// Inspired by https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/webgl-ext/index.d.ts
...
interface WebGL1Extensions {
  ...
  getExtension(name: "WEBGL_compressed_texture_etc"): WEBGL_compressed_texture_etc;
