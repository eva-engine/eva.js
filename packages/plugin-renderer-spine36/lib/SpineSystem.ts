...
/**
 * Spine 骨骼动画渲染系统（pixi-spine 3.6 版本）
 *
 * 此系统继承自 `@eva/spine-base` 的 SpineSystem 基类，使用 pixi-spine 3.6 版本。
 * 负责管理所有 Spine 组件的骨架创建、动画更新和资源管理。
 *
 * 适用于需要使用 Spine 3.6 格式骨骼动画的场景（如旧项目兼容）。
 *
 ...
 * import { SpineSystem } from '@eva/plugin-renderer-spine36';
 *
 * const game = new Game({
 *   systems: [
 *     new RendererSystem({
