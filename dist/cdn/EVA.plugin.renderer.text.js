(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('pixi.js'),
        require('@eva/eva.js'),
        require('@eva/plugin-renderer'),
        require('@eva/renderer-adapter'),
      )
    : typeof define === 'function' && define.amd
    ? define(['exports', 'pixi.js', '@eva/eva.js', '@eva/plugin-renderer', '@eva/renderer-adapter'], factory)
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory(
        ((global.EVA = global.EVA || {}),
        (global.EVA.plugin = global.EVA.plugin || {}),
        (global.EVA.plugin.renderer = global.EVA.plugin.renderer || {}),
        (global.EVA.plugin.renderer.text = {})),
        global.PIXI,
        global.EVA,
        global.EVA.plugin.renderer,
        global.EVA.rendererAdapter,
      ));
})(this, function (exports, pixi_js, eva_js, pluginRenderer, rendererAdapter) {
  'use strict';
  ...
  __decorate([eva_js.decorators.IDEProp], Text$2.prototype, 'text', void 0);
  __decorate([eva_js.decorators.IDEProp], Text$2.prototype, 'style', void 0);
