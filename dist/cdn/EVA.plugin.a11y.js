(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@eva/eva.js'), require('pixi.js'))
    : typeof define === 'function' && define.amd
    ? define(['exports', '@eva/eva.js', 'pixi.js'], factory)
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory(
        ((global.EVA = global.EVA || {}), (global.EVA.plugin = global.EVA.plugin || {}), (global.EVA.plugin.a11y = {})),
        global.EVA,
        global.PIXI,
      ));
})(this, function (exports, eva_js, pixi_js) {
  'use strict';
  ...
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'interactive', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'hint', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'event', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'delay', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'role', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'props', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'state', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'attr', void 0);
  __decorate([eva_js.decorators.IDEProp], A11y.prototype, 'a11yId', void 0);
  ...
  var typedArrayTags = {};
  typedArrayTags[float32Tag] = typedArrayTags[float64Tag] = typedArrayTags[int8Tag] = typedArrayTags[int16Tag] = typedArrayTags[
    int32Tag
  ] = typedArrayTags[uint8Tag] = typedArrayTags[uint8ClampedTag] = typedArrayTags[uint16Tag] = typedArrayTags[uint32Tag] = true;
  typedArrayTags[argsTag$1] = typedArrayTags[arrayTag$1] = typedArrayTags[arrayBufferTag] = typedArrayTags[
    boolTag
  ] = typedArrayTags[dataViewTag$1] = typedArrayTags[dateTag] = typedArrayTags[errorTag] = typedArrayTags[
    funcTag
  ] = typedArrayTags[mapTag$1] = typedArrayTags[numberTag] = typedArrayTags[objectTag$2] = typedArrayTags[
    regexpTag
  ] = typedArrayTags[setTag$1] = typedArrayTags[stringTag] = typedArrayTags[weakMapTag$1] = false;
  ...
  function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
    ...
    while (++index < objLength) {
      ...
      // Recursively compare objects (susceptible to call stack limits).
      if (
        !(compared === undefined ? objValue === othValue || equalFunc(objValue, othValue, bitmask, customizer, stack) : compared)
      ) {
        result = false;
        break;
      }
